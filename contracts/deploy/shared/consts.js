...
const policies = {
  ...
  butter:
    "QmSv9ohhChMtyqwqsvfgeJtZQBWkwAboBc1n3UGvprfdd7/Conditional_Funding_Markets_-_Question_Resolution_Policy.pdf",
...
function generatePolicyUri(policy = "default") {
  ...
  if (!policyPath) {
    throw new Error(
      `Policy not found: ${policy}. Valid options are: ${Object.keys(policies).join(", ")}.`
    );
  }
