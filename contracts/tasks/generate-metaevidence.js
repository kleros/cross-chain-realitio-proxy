...
task("generate-metaevidence", "Generates metaevidence.json with populated chain IDs")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const template = {
      ...
      "evidenceDisplayInterfaceURI": "/ipfs/QmcJ3nNcEKLPjFcvKnAdPftyKCNEYj7CQQoZDUDKUj4Eyk/index.html",
      "dynamicScriptURI": "/ipfs/QmTM7aQN7MuTuDuoGDvzp8Wy7FpxqA9twQ1NeeLfQP7DbS",
