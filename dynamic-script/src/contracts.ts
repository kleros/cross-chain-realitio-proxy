...
export const foreignProxyAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'bytes32', name: '_questionID', type: 'bytes32' },
      { indexed: true, internalType: 'address', name: '_requester', type: 'address' },
...
export const realitioAbi = [
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes32', name: 'history_hash', type: 'bytes32' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'template_id', type: 'uint256' },
      { indexed: true, internalType: 'address', name: 'user', type: 'address' },
      { indexed: false, internalType: 'string', name: 'question_text', type: 'string' },
    ],
    name: 'LogNewTemplate',
    type: 'event',
  },
